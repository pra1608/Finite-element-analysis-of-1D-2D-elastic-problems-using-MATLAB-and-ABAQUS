...
global geom connec dee nf Nodal_loads traction_loads
global Length Width NXE NYE X_origin Y_origin dhx dhy nbe 
global Width  nbe connec nnd
global geom ngp traction_loads nel nne

%
format long g
fid =fopen('bar_1_results.txt','w');
disp('Results printed to file : bar_1_results.txt');
%
...
for i = 1:size(n_bc,2)
        ...
        traction_loads(node2,2) = ft(4);       % nodal bounbdary force vector
